...
//	May use new NASA WMTS : http://onearth.jpl.nasa.gov/wms.cgi?request=GetCapabilities
	...
	new OpenLayers.Layer.WMS(
            "Ortofoto San Ficticio",
            'http://localhost:8080/geoserver/san_ficiticio/wms?',
            {layers: "san_ficticio:san_ficticio", format: 'image/png'},
            {singleTile: true, opacity: 1, isBaseLayer: true, visibility: true, noLegend: true, transitionEffect: 'resize'}
    ),
/*	
	new OpenLayers.Layer.WMS(
            "WMS Layer Title",
...
*/	
	...
	new OpenLayers.Layer.WMS(
            "Separador",
            'http://localhost:8080/geoserver/san_ficiticio/wms?',
            {layers: "san_ficticio:separador", transparent: true, format: 'image/png'},
            {singleTile: true, opacity: 0.6, isBaseLayer: false, visibility: true, noLegend: false, transitionEffect: 'resize'}
    ),	

	new OpenLayers.Layer.WMS(
            "Puente",
            'http://localhost:8080/geoserver/san_ficiticio/wms?',
            {layers: "san_ficticio:puente", transparent: true, format: 'image/png'},
            {singleTile: true, opacity: 0.6, isBaseLayer: false, visibility: true, noLegend: false, transitionEffect: 'resize'}
    ),	
	...
	new OpenLayers.Layer.WMS(
            "Calzada",
            'http://localhost:8080/geoserver/san_ficiticio/wms',
            {layers: "san_ficticio:calzada", transparent: true, format: 'image/png'},
            {singleTile: true, opacity: 0.6, isBaseLayer: false, visibility: true, noLegend: false, transitionEffect: 'resize'}
    ),	
	...
	new OpenLayers.Layer.WMS(
            "Malla Vial",
            'http://localhost:8080/geoserver/san_ficiticio/wms',
            {layers: "san_ficticio:mallaVial", transparent: true, format: 'image/png'},
            {singleTile: true, opacity: 0.6, isBaseLayer: false, visibility: true, noLegend: false, transitionEffect: 'resize'}
    ),
	...
	new OpenLayers.Layer.WMS(
            "Tratamiengo Aguas",
            'http://localhost:8080/geoserver/san_ficticio/wms?',
            {layers: "san_ficticio:tratamientoAguas", transparent: true, format: 'image/png'},
            {singleTile: true, opacity: 0.6, isBaseLayer: false, visibility: true, noLegend: false, transitionEffect: 'resize'}
    ),

	new OpenLayers.Layer.WMS(
            "Arbustales",
            'http://10.20.151.168:8080/geoserver/Pto_Caldas/wms?',
            {layers: "Pto_Caldas:Arbustales", transparent: true, format: 'image/png'},
            {singleTile: true, opacity: 1, isBaseLayer: false, visibility: true, noLegend: false, transitionEffect: 'resize'}
    ),

    new OpenLayers.Layer.WMS(
            "Bosques",
            'http://10.20.151.168:8080/geoserver/Pto_Caldas/wms?',
            {layers: "Pto_Caldas:Bosques", transparent: true, format: 'image/png'},
            {singleTile: true, opacity: 1, isBaseLayer: false, visibility: true, noLegend: false, transitionEffect: 'resize'}
    ), 
	...
	new OpenLayers.Layer.WMS(
            "Pastos",
            'http://10.20.151.168:8080/geoserver/Pto_Caldas/wms?',
            {layers: "Pto_Caldas:Pastos", transparent: true, format: 'image/png'},
            {singleTile: true, opacity: 1, isBaseLayer: false, visibility: true, noLegend: false, transitionEffect: 'resize'}
    ), 
	...
	new OpenLayers.Layer.WMS(
            "Rastrojos",
            'http://10.20.151.168:8080/geoserver/Pto_Caldas/wms?',
            {layers: "Pto_Caldas:Rastrojos", transparent: true, format: 'image/png'},
            {singleTile: true, opacity: 1, isBaseLayer: false, visibility: true, noLegend: false, transitionEffect: 'resize'}
    ),

	new OpenLayers.Layer.WMS(
            "Suelos Semi-desnudos",
            'http://10.20.151.168:8080/geoserver/Pto_Caldas/wms?',
            {layers: "Pto_Caldas:Suelos_Semidesnudos", transparent: true, format: 'image/png'},
            {singleTile: true, opacity: 1, isBaseLayer: false, visibility: true, noLegend: false, transitionEffect: 'resize'}
    ),

	new OpenLayers.Layer.WMS(
            "Predios Urbanos",
            'http://10.21.3.92:8080/geoserver/San_Ficticio/wms?',
            {layers: "San_Ficticio:predios_urba", transparent: true, format: 'image/png'},
            {singleTile: true, opacity: 0.6, isBaseLayer: false, visibility: true, noLegend: false, transitionEffect: 'resize'}
    ), 
    ...
    new OpenLayers.Layer.WMS(
            "Predios Rurales",
            'http://10.21.3.92:8080/geoserver/San_Ficticio/wms?',
            {layers: "San_Ficticio:predios_rur", transparent: true, format: 'image/png'},
            {singleTile: true, opacity: 0.6, isBaseLayer: false, visibility: true, noLegend: false, transitionEffect: 'resize'}
    ), 
    new OpenLayers.Layer.WMS(
            "Predios Expansion",
            'http://10.21.3.92:8080/geoserver/San_Ficticio/wms?',
            {layers: "San_Ficticio:predios_expansion", transparent: true, format: 'image/png'},
            {singleTile: true, opacity: 0.6, isBaseLayer: false, visibility: true, noLegend: false, transitionEffect: 'resize'}
    ), 
	
	new OpenLayers.Layer.WMS(
            "Drenaje Doble",
            'http://10.20.151.163:8080/geoserver/SuperficiesdeAgua/wms?',
            {layers: "SuperficiesdeAgua:DrenajeDoble", transparent: true, format: 'image/png'},
            {singleTile: true, opacity: 0.6, isBaseLayer: false, visibility: true, noLegend: false, transitionEffect: 'resize'}
    ),
	...
	new OpenLayers.Layer.WMS(
            "Drenaje Sencillo",
            'http://10.20.151.163:8080/geoserver/SuperficiesdeAgua/wms?',
            {layers: "SuperficiesdeAgua:Drenaje Sencillo", transparent: true, format: 'image/png'},
            {singleTile: true, opacity: 0.6, isBaseLayer: false, visibility: true, noLegend: false, transitionEffect: 'resize'}
    ),
	...
	new OpenLayers.Layer.WMS(
            "Jaguey_R",
            'http://10.20.151.163:8080/geoserver/SuperficiesdeAgua/wms?',
            {layers: "SuperficiesdeAgua:Jaguey_R", transparent: true, format: 'image/png'},
            {singleTile: true, opacity: 0.6, isBaseLayer: false, visibility: true, noLegend: false, transitionEffect: 'resize'}
    ),
	...
	new OpenLayers.Layer.WMS(
            "Cuerpos de Agua",
            'http://10.20.151.163:8080/geoserver/SuperficiesdeAgua/wms?',
            {layers: "SuperficiesdeAgua:Cuerpos de Agua", transparent: true, format: 'image/png'},
            {singleTile: true, opacity: 0.6, isBaseLayer: false, visibility: true, noLegend: false, transitionEffect: 'resize'}
    ),
...
Heron.options.info.html = 'Este es un ejemplo';
